...
public class disjunction extends wff {
    private wff inner1;
    private wff inner2;

    public disjunction(wff inner1, wff inner2) {
        this.inner1 = inner1;
        this.inner2 = inner2;
    }
    ...
    public boolean equals(wff other) {
        ...
        wff otherI1 = ((disjunction) other).getInner1();
        if (!otherI1.equals(inner1)) {
            return false;
        }
        wff otherI2 = ((disjunction) other).getInner2();
    ...
    wff makeNewCopyWithSubformulaAtIndexSubstitutedWith(int index, wff to) {
        if (index == 0) {
            return new disjunction(to, inner2);
        }
        return new disjunction(inner1, to);
    }
