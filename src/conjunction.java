...
public class conjunction extends wff {
    ...
    public conjunction(wff inner1, wff inner2) {
        this.inner1 = inner1;
        this.inner2 = inner2;
    }
    ...
    public boolean equals(wff other) {
        ...
        wff otherI1 = ((conjunction) other).getInner1();
        if (!otherI1.equals(inner1)) {
            return false;
        }
        wff otherI2 = ((conjunction) other).getInner2();
    ...
    wff makeNewCopyWithSubformulaAtIndexSubstitutedWith(int index, wff to) {
        if (index == 0) {
            return new conjunction(to, inner2);
        }
        return new conjunction(inner1, to);
    }
